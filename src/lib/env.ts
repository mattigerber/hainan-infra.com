...
const pocketRpcUrl =
  readPublicEnv(process.env.NEXT_PUBLIC_POCKET_RPC) ||
  readPublicEnv(process.env.NEXT_PUBLIC_MAINNET_POCKET_RPC_URL);

const lavaRpcUrl =
  readPublicEnv(process.env.NEXT_PUBLIC_LAVA_RPC) ||
  readPublicEnv(process.env.NEXT_PUBLIC_MAINNET_LAVA_RPC_URL);
